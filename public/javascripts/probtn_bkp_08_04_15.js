            ...
            if ((window.jscd.browserMajorVersion > "8") || (window.jscd.browser !== "Microsoft Internet Explorer")) {
                ...
                function setIfameSizes() {
                    ...
                    if ((params.iframeScaleMinWidth !== 0) && (params.iframeScaleMinWidth > $(".fancybox-inner").first().width())) {
                        console.log(params.iframeScaleMinWidth);
                ...
                function onOrientationChange(e) {
                    ...
                    console.log("pizzabtn.left - " + $("#pizzabtn").position().left);
                    console.log("(window.innerWidth - params.ButtonSize.W) - " + (window.innerWidth - params.ButtonSize.W));
                    if ($("#pizzabtn").position().left > (window.innerWidth - params.ButtonSize.W)) {
                        $("#pizzabtn").css("left", window.innerWidth - params.ButtonSize.W);
                    }
                    console.log("pizzabtn.top - " + $("#pizzabtn").position().top);
                    console.log("(window.innerHeight - params.ButtonSize.H) - " + (window.innerHeight - params.ButtonSize.H));
                ...
                function BeginButtonProcess() {
                    ...
                    function AllLoadedButtonProcess() {
                        ...
                        pizzabtn.pep({
                            ...
                            drag: function () {
                                MaximizeWrapper(function () {
                                    console.log("MaximizeWrapper drag");
                            ...
                            stop: function () {
                                ...
                                if (!pizzabtn.moved) {
                                    //if button clicked
                                    MaximizeWrapper(function () {
                                        console.log("MaximizeWrapper stop");
                        ...
                        function onButtonTap() {
                            ...
                            var fancyboxParams = {
                                ...
                                afterShow: function () {
                                    ...
                                    var video = $("#video_probtn").get(0); video.play();
                                },
                                afterClose: function () {
