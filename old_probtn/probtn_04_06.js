            ...
            onButtonTap: function (currentContentURL, areaName, currentButtonContentType) {
                ...
                if ((ProBtnControl.params.ClickCounterLink) && (ProBtnControl.params.ClickCounterLink !== "")) {
                    try {
                        ...
                        var clickCounterLink_random = ProBtnControl.params.ClickCounterLink;
                        var clickCounterLink_random = ProBtnControl.params.ClickCounterLink.replace(/\[RANDOM\]/g, ProBtnControl.additionalButtonFunctions.randomString(12));
                        if (clickCounterLink_random == ProBtnControl.params.ClickCounterLink) {
                                    ...
                                    $(document).on("click", ".probtn_menu_link", function () {
                                        ...
                                        switch (menuType) {
                                            ...
                                            case "video":
                                                ...
                                                ProBtnControl.onButtonTap($(this).attr("href"), null, "video");
                                                break
                                            default:
                                                ProBtnControl.statistics.sendAreaActivatedStats($(this).attr("rel"));
                                                window.open($(this).attr("href"));
          ...
          <source src="' + ProBtnControl.params.ContentURL + '" type="video/mp4"> \
            Your browser does not support the video tag. \
                    ...
                    if ((ProBtnControl.params.TrackingLink !== null) && (ProBtnControl.params.TrackingLink !== null) && (ProBtnControl.params.TrackingLink !== "")) {
                        ...
                        var probtn_TrackingLink_random = ProBtnControl.params.TrackingLink.replace(/\[RANDOM\]/g, ProBtnControl.additionalButtonFunctions.randomString(12));
                        ...
                        setTimeout(function () {
                            if ((ProBtnControl.params.isAnimation == "anim1") || (ProBtnControl.params.isAnimation == "anim2")) {
                                ...
                                ProBtnControl.additionalButtonFunctions.MaximizeWrapper(function () {
                                    ...
                                    var count = 0;
                                    console.log('($("body").innerWidth() - ProBtnControl.pizzabtn.width())' + ($("body").innerWidth() - ProBtnControl.pizzabtn.width()));
                                    ProBtnControl.pizzabtn.animate({
                                        ...
                                        step: function (now) {
                                            ...
                                            console.log(ProBtnControl.pizzabtn.position());
