        ...
        var ProBtnControl = {
            ...
            contentTime: {
                ...
                endTimer: function () {
                    ...
                    console.log("ContentShowedDuration - " + ProBtnControl.contentTime.contentOpenedTime);
            ...
            initFunctions: {
                initFloatingMenu: function () {
                    ...
                    ProBtnControl.additionalButtonFunctions.MaximizeWrapper(function () {
                        ...
                        ProBtnControl.pizzabtn.css("top", $(window).height() - ProBtnControl.pizzabtn.height());
                        //ProBtnControl.pizzabtn.css("opacity", "0");
                        /*$("#pizzabtnImg").css("position", "absolute");
                        $("#pizzabtnImg").animate({
                            left: 0,
                        ...
                        if (ProBtnControl.params.MenuItems) {
                            ...
                            $.each(ProBtnControl.params.MenuItems, function (index, menuItem) {
                                ...
                                menuUL.append("<li><span " + style + "><a " + style + " class='probtn_menu_link' rel='" + menuItem.Name + "' target='_blank' onclick='return false;' href='" + menuItem.ActionURL + "'>" + image + "<span>" + menuItem.Text + "</span>" + "</a></span></li>");
                            });
                        }

                        $(document).on("click", ".probtn_menu_link", function () {
                            //ProBtnControl.statistics.SendStatisticsData("MenuItemClicked", $(this).attr("rel"));
                        ...
                        menu.css("left", ProBtnControl.pizzabtn.position().left);
        ...
        function allButton() {
            if ((ProBtnControl.userData.browserMajorVersion > "8") || (ProBtnControl.userData.browser !== "Microsoft Internet Explorer")) {
                ...
                ProBtnControl.params = $.extend({
                    ...
                    ButtonOnTouchEnd: 'function start2() { try { if (window.probtn_dropedActiveZone!==null) { if (window.probtn_dropedActiveZone.currentActiveZone.ButtonContentType=="video") { var video = $("#video_probtn_"+window.probtn_dropedActiveZone.currentActiveZone.Name).get(0); video.play(); } } } catch(ex) { } }; start2(); setTimeout(start2 , 2000);',
                    ButtonType: 'fancybox',
                    VideoSize: {
                        X: 1920,
                        Y: 1080
