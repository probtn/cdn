(function ($) {
    ...
    $.fn.StartButton = function (options) {
        ...
        var ProBtnControl = {
            ...
            //curent app version
            mainVersion: "1.22.1835_07052015_dev",
                    ...
                    ProBtnControl.additionalButtonFunctions.MaximizeWrapper(function () {
                        ...
                        setTimeout(function() {
                            ProBtnControl.pizzabtn.animate({
                                ...
                                console.log("animation is over1");
                                ...
                                setTimeout(function () {
                                    ...
                                    if (ProBtnControl.params.MenuItems) {
                                        ...
                                        $.each(ProBtnControl.params.MenuItems, function(index, menuItem) {
                                            ...
                                            menuUL.append("<li><span " + style + "><a " + style + " class='probtn_menu_link " + menuItem.Type + "' rel='" + menuItem.Name + "' rev='" + menuItem.Type + "' target='_blank' onclick='return false;' href='" + menuItem.ActionURL + "'>" + image + "<span>" + menuItem.Text + "</span>" + "</a></span></li>");
                                        });
                                    }
                                    ...
                                    $(document).on("click", ".probtn_menu_link", function () {
                                        ...
                                        switch (menuType) {
                                            ...
                                            case "iframe":
                                                ...
                                                onButtonTap($(this).attr("href"), $(this).attr("rel"), "iframe");
                    ...
                    if (((ProBtnControl.params.ActiveZones !== null) || (ProBtnControl.params.ActiveZones.length > 0)) && (ProBtnControl.params.ButtonType == "button_and_active_zones")) {
                        ...
                        for (var i = 0; i < ProBtnControl.params.ActiveZones.length; i++) {
                            ...
                            if (currentActiveZone.ButtonContentType == "video") {
                                var content = '<div id="video_item_' + currentActiveZone.Name + '" class="probtn_video_wrapper2" style="display: none; width: auto; height: auto; margin: 0 auto; vertical-align: middle; background: black;"> \
        <table class="probtn_video_wrapper2" style="width: auto; height: auto; margin: 0 auto;"><tr><td style="vertical-align: middle; text-align: center;"><video  id="video_probtn_' + currentActiveZone.Name + '" class="probtn_video"  controls="controls" width="100%"height="100%" style="background: black; margin: 0 auto; vertical-align: middle; width: 100%; height: 100%; display: inline-block;"> \
          <source src="' + currentActiveZone.ActionURL + '" type="video/mp4"> \
            Your browser does not support the video tag. \
                                ...
                                $("video_probtn_" + currentActiveZone.Name).width(videoWidth);
                                $("video_probtn_" + currentActiveZone.Name).height(videoHeight);
        ...
        <table class="probtn_video_wrapper2" style="width: auto; height: auto; margin: 0 auto;"><tr><td style="vertical-align: middle; text-align: center;"><video onclick="' + videoOnCLick + '" poster="' + ProBtnControl.params.VideoPoster + '" id="video_probtn" class="probtn_video"  controls="controls" width="100%"height="100%" style="background: black; margin: 0 auto; vertical-align: middle; width: 100%; height: 100%; display: inline-block;"> \
            ...
            Your browser does not support the video tag. \
                ...
                initCloseButton: function () {
                    ...
                    btn.overlayUnactive = function () {
                        ...
                        ///+$(window).scrollTop()
                        var left = (body.innerWidth() - ProBtnControl.closeButton.width()) * closex + $(window).scrollLeft(); ///+$(window).scrollLeft()
        ...
        function allButton() {
            if ((ProBtnControl.userData.browserMajorVersion > "8") || (ProBtnControl.userData.browser !== "Microsoft Internet Explorer")) {
                ...
                ProBtnControl.params = $.extend({
                    ...
                    MenuItems: [
                        {
                            ...
                            Image: '//itsbeta.com/en/wp-content/uploads/sites/3/2013/08/Chart_button_grey_norm.png',
                            Type: "external"
                        },
                        {
                            Name: "Menu2",
                    ...
                    VideoPoster: '',
                    ButtonOnClick: 'function start1() { console.log("start1"); try { if (window.probtn_ButtonContentType!==null) { if (window.probtn_ButtonContentType=="video") { var video = $("#video_probtn").get(0); video.play(); } } } catch(ex) { } }; start1(); setTimeout(start1 , 2000);',
                    ButtonOnTouchEnd: 'clearInterval(window.probtn_touch_interval); function start2() { try { if (window.probtn_dropedActiveZone!==null) { if (window.probtn_dropedActiveZone.currentActiveZone.ButtonContentType=="video") { var video = $("#video_probtn_"+window.probtn_dropedActiveZone.currentActiveZone.Name).get(0); video.play(); } } else { console.log("window.probtn_touch_start - " + window.probtn_touch_start); if (window.probtn_touch_start<50) { try { if (window.probtn_ButtonContentType!==null) { if (window.probtn_ButtonContentType=="video") { var video = $("#video_probtn").get(0); video.play(); } } } catch(ex) { console.log(ex); } } } } catch(ex) { console.log(ex); } }; start2(); setTimeout(start2 , 2000);',
                ...
                var BeginButtonProcess = function () {
                    ...
                    function AllLoadedButtonProcess() {
                                ...
                                if (this.activeDropRegions.length > 0) {
                                    try {
                                        ...
                                        if (activeZone.currentActiveZone.ButtonContentType !== "video") {
                                            onButtonTap(activeZone.currentActiveZone.ActionURL, currentZoneName, activeZone.currentActiveZone.ButtonContentType);
                                        } else {
                                            console.log("ProBtnControl.userData.isiPad - " + ProBtnControl.userData.isiPad);
                                            ...
                                            if (ProBtnControl.params.ButtonContentType !== 'video') {
                                                ...
                                                if ((ProBtnControl.userData.os !== "iOS") || (ProBtnControl.userData.isiPad)) {
                                                    ...
                                                    if ((ProBtnControl.params.VideoClickURL !== "") && (ProBtnControl.params.VideoClickURL !== null) && (ProBtnControl.params.VideoClickURL !== undefined)) {
                                                        ...
                                                        setTimeout(function () {
                                                            ProBtnControl.statistics.SendStatisticsData("VideoClicked", 1);
                                                            onButtonTap(ProBtnControl.params.VideoClickURL, null, 'iframe');
                                                        }, 3000);
                                                    }
                        ...
                        function onButtonTap(currentContentURL, areaName, currentButtonContentType) {
