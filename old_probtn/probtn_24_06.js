...
(function ($) {
    ...
    $.fn.StartButton = function (options) {
        ...
        var ProBtnControl = {
            ...
            //curent app version
            mainVersion: "1.28.1800_19062015_dev",
            ...
            initFunctions: {
                ...
                fullscreenInitAndShow: function () {
                    ...
                    if (cookieHideAfterClose === null) {
                        ...
                        var iframeOverlay = '';
                        console.log("ProBtnControl.params.FullscreenClickLink - " + ProBtnControl.params.FullscreenClickLink);
