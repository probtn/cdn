...
(function ($) {
    ...
    $.fn.StartButton = function (options) {
        ...
        var ProBtnControl = {
            ...
            //curent app version
            mainVersion: "1.23.1753_28052015_dev",
            ...
            statistics: {
                createClickCounterImage: function(clickPath) {
                    ...
                    var clickCounterLink_random = clickPath.replace(/\[RANDOM\]/g, ProBtnControl.additionalButtonFunctions.randomString(12));
        ...
        <table class="probtn_video_wrapper2" style="width: auto; height: auto; margin: 0 auto;"><tr><td style="vertical-align: middle; text-align: center;"><video  id="' + videoItemNameVideo + '" class="probtn_video"  controls="controls" width="100%"height="100%" style="background: black; margin: 0 auto; vertical-align: middle; width: 100%; height: 100%; display: inline-block;"> \
                                ...
                                setTimeout(function () {
                                    ...
                                    if (ProBtnControl.params.MenuItems) {
                                        ...
                                        $.each(ProBtnControl.params.MenuItems, function (index, menuItem) {
                                            ...
                                            menuUL.append("<li><span " + style + "><a " + style + " class='probtn_menu_link " + menuItem.Type + "' rel='" + menuItem.Name + "' rev='" + menuItem.Type + "' target='_blank' onclick='"+onclick+"' href='" + actionURL + "'>" + image + "<span>" + menuItem.Text + "</span>" + "</a></span></li>");
                    ...
                    try {
                        ...
                        if (ProBtnControl.params.ButtonType == "menu") {
                            if ($("#probtn_menu").length > 0) {
                                ...
                                $("#probtn_menu").css("top", ProBtnControl.pizzabtn.position().top - $("#probtn_menu").height());
