...
(function ($) {
    ...
    $.fn.StartButton = function (options) {
        ...
        var ProBtnControl = {
            ...
            //curent app version
            mainVersion: "1.18.1118_13042015_dev",
                            ...
                            if (ProBtnControl.params.isAnimation == "anim1") {
                                ...
                                var parabolic = function () {
                                    ...
                                    this.css = function (p) {
                                        ...
                                        var outCss = { 'top': y + "px", 'left': x + "px", 'opacity': p };
          ...
          <source src="' + ProBtnControl.params.ContentURL + '" type="video/mp4"> \
            ...
            function initScrollChange(runOnscroll) {
                ...
                var onScroll = function (e) {
                    if (ProBtnControl.params.Debug) console.log(e);
                    ...
                    $.each(ProBtnControl.params.ScrollZones, function (index, scrollZone) {
                        ...
                        var buttonHeight = ProBtnControl.pizzabtn.position().top + top;
                ...
                if (((ProBtnControl.params.ActiveZones !== null) || (ProBtnControl.params.ActiveZones.length > 0)) && (ProBtnControl.params.ButtonType == "button_and_active_zones")) {
                    ...
                    for (var i = 0; i < ProBtnControl.params.ActiveZones.length; i++) {
                        ...
                        activeZoneBtn.animateActive = function () {
                            ...
                            /*}, 500, function() {
                            if (ProBtnControl.params.Debug) console.log(activeZoneBtn.currentActiveZone.Name + " active animation complite");*/
                            //}
                        }
                        ...
                        activeZoneBtn.animateInactive = function () {
                            ...
                            /*if (this.isActive == true) {
                                console.log("animateInactive2");
                                this.isActive = false;
                                this.attr("src", this.currentActiveZone.InactiveImage);
                                var activeZoneBtn = this;
                                this.stop(true, true).animate({
                                    width: activeZone.currentActiveZone.InactiveSize.W,
                                    height: activeZone.currentActiveZone.InactiveSize.H,
                                    ...
                                    if (ProBtnControl.params.Debug) console.log(activeZoneBtn.currentActiveZone.Name + " inactive animation complite");
                                });
                            } else {*/
                            //console.log("animateInactive3");
                            var activeZoneBtn = this;
                            activeZoneBtn.css({
                                width: activeZone.currentActiveZone.InactiveSize.W,
                                height: activeZone.currentActiveZone.InactiveSize.H,
