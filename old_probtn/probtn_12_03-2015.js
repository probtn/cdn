(function ($) {
    ...
    $.fn.StartButton = function (options) {
        ...
        var ProBtnControl = {
            //curent app version
            mainVersion: "1.13.2353_05032015_dev",
            ...
            HpmdFunctions: {
                ...
                expandHpmdTrack: function () {
                    console.log(ProBtnControl.params);
                    console.log(ProBtnControl.params.hpmd);
        ...
        function allButton() {
            if ((ProBtnControl.userData.browserMajorVersion > "8") || (ProBtnControl.userData.browser !== "Microsoft Internet Explorer")) {
                ...
                if ((ProBtnControl.params.domain != "") && (ProBtnControl.params.domain != null)) {
                    currentDomain = ProBtnControl.params.domain;
                } else { };
                ...
                function startAppBanner() {
                    console.log("startAppBanner");
                    //console.log(ProBtnControl.params);
                    if (ProBtnControl.params.isSmartBanner) {
                        ...
                        $.getScript(ProBtnControl.params.smartbannerJsPath, function () {
                            //console.log(ProBtnControl.params.smartbanner);
                ...
                function BeginButtonProcess() {
                    ...
                    function AllLoadedButtonProcess() {
                        ...
                        ProBtnControl.pizzabtn.pep({
                            ...
                            stop: function () {
                                ...
                                if (!ProBtnControl.pizzabtn.moved) {
                                    ...
                                    MinimizeWrapper(function () { }, ProBtnControl.params.MinimizeWrapperTime);
                        ...
                        function onButtonTap() {
                            console.log("ProBtnControl.HpmdFunctions.expandHpmdTrack()");
                            ...
                            var fancyboxParams = {
                                href: ProBtnControl.params.ContentURL,
                ...
                function SendStat(name, value, probtnId, currentDomain) {
                    $.getJSON(ProBtnControl.serverUrl + "/1/functions/updateUserStatistic?BundleID=" + currentDomain + "&Version=1.0&DeviceType=web&CampaignID=" + ProBtnControl.params.CampaignID + "&DeviceUID=" + probtnId + "&localDomain=" + realDomain + "&Statistic=" + "{\"" + name + "\": \"" + value + "\"}&" + "X-ProBtn-Token=b04bb84b22cdacb0d57fd8f8fd3bfeb8ad430d1b&callback=?",
