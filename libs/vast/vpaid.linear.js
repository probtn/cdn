!(function (currentWindow, currentDocument, i) {
    ...
    function r(e) {
        this.rootElement = e;
        this.intersectionSupport = !!currentWindow.IntersectionObserver;
        this.intersectionRatio = -1;
    }
    function n(t) {
        switch (t.type) {
            case eventDescriptionObject.AdVideoStart:
                videoDomElementsAndPostMessages.hide(!1);
                videoDomElementsAndPostMessages.updateSize();
                mainAdObject.state = eventDescriptionObject.AdStarted;
                mainAdObject.state = eventDescriptionObject.AdImpression;
                mainAdObject.state = eventDescriptionObject.AdVideoStart;
                break;
            ...
            case eventDescriptionObject.AdVideoComplete:
                mainAdObject.customParams.fdc
                    ? (eventProcessingObject.callEvent(
                    eventDescriptionObject.create(
                        eventDescriptionObject.AdVideoComplete,
                        mainAdObject.metaData
                    )
                    ),
                    ...
                    : ((mainAdObject.state = eventDescriptionObject.AdVideoComplete),
                    mainAdObject.customParams.nr ||
                    videoDomElementsAndPostMessages.flags.userInteraction ||
                    (A.stop(),
                        videoDomElementsAndPostMessages.hide(!0),
                        setTimeout(function () {
                            E.stopAd();
            ...
            case eventDescriptionObject.AdPlaying:
                ...
                break;
            default:
                injectContentObject.error(
                    "======================== UNTREATED MEDIA EVENT ========================>",
                    t
                );
        }
    }
    ...
    function s(t) {
        if (
            t.type === videoDomElementsAndPostMessages.EVENT ||
            t.type === videoDomElementsAndPostMessages.EVENTRTB
        ) {
            return processCreativeEventWithData.call(this, t);
        }
        if (t.type === videoDomElementsAndPostMessages.APPLY) {
            if (
                ("resumeAd" === t.data.method &&
                mainAdObject.flags.userEngaged &&
                (mainAdObject.flags.userEngaged = !1),
                "function" == typeof E[t.data.method])
            )
                return E[t.data.method].apply(possibleMainAdUnit, t.data.args);
            if ("function" == typeof videoDomElementsAndPostMessages[t.data.method])
                return videoDomElementsAndPostMessages[t.data.method].apply(
                    videoDomElementsAndPostMessages,
                    t.data.args
                );
        }
        if (t.type === videoDomElementsAndPostMessages.VIDEO && S.video)
            return S.video.eventHandler.call(S.video, t.data);
        switch (t.data.type) {
            ...
            case eventDescriptionObject.AdClickThru:
                console.log("eventDescriptionObject.AdClickThru", t.data, t);
                if (t.data.url) {
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(eventDescriptionObject.AdClickThru, {
                            playerHandles: !0,
                            id: t.data.id,
                            url: t.data.url,
                        })
                    ),
                    t.data.pause && E.pauseAd(),
                        /*mainAdObject.customParams.cet &&
                                Math.round(mainAdObject.metaData.currentTime) >= 0 &&
                                cntEventsTracking.customEvent(
                                    "AdVideoClick" + Math.round(mainAdObject.metaData.currentTime)
                                ),*/
                    mainAdObject.customParams.kac > 0 &&
                    (mainAdObject.customParams.nov ? p.stop() : mainVideo.stop(),
                        A.stop(),
                        S.stop(),
                        videoDomElementsAndPostMessages.hide(!0),
                        setTimeout(function () {
                    ...
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(eventDescriptionObject.AdClickThru, {
                            playerHandles: t.data.playerHandles || !1,
                            id: t.data.id
                        })
                    );
                    t.data.pause && E.pauseAd();
                    mainAdObject.customParams.kac > 0 &&
                    (mainAdObject.customParams.nov
                        ? (p.stop())
                        : mainVideo.stop(),
                        A.stop(),
                        S.stop(),
    ...
    function processCreativeEventWithData(creativeEventWithData) {
        if (
            creativeEventWithData.type === videoDomElementsAndPostMessages.EVENT &&
            creativeEventWithData.data.type
        ) {
            mainAdObject.isPreviewer &&
            console.log(
                "JS-VPAID-VIEWST::CUSTOM EVENT =>",
                creativeEventWithData.data.type
            );
        } else {
            creativeEventWithData.type === videoDomElementsAndPostMessages.EVENTRTB &&
            (0 !== mainAdObject.customParams.impid &&
            cntEventsTracking.rtbEvent(creativeEventWithData.data),
            mainAdObject.isPreviewer &&
            console.log(
                "JS-VPAID-VIEWST::RTB EVENT ID =>",
                creativeEventWithData.data
            ));
        }
    }

    var eventProcessingObject,
    ...
    Object.defineProperty(Object, "assign", {
        ...
        value: function (t, e) {
            ...
            for (var i = Object(t), a = 1; a < arguments.length; a++) {
                ...
                if (void 0 !== o && null !== o)
                    for (
                        var r = Object.keys(Object(o)), n = 0, s = r.length;
                        n < s;
                        n++
                    ) {
                        var d = r[n],
            ...
            (this.active = !0),
                ...
                (this.targetWindow = (function () {
                    ...
                    try {
                        for (
                            ;
                            e.parent !== e && e.parent.document.domain === e.document.domain;
                ...
                (this.slot = this.targetWindow.document.body),
                this.initEvents(this.targetWindow);
        },
        stop: function () {
            if (this.active) {
    ...
    o.prototype.eventHandler = function (t) {
        (this.props = Object.assign(this.props, t.props)),
        this.handlers[t.type] &&
        "function" == typeof this.handlers[t.type] &&
        this.handlers[t.type].call(this, {
            type: t.type,
            target: this,
        });
    };
    ...
    T = {
                ...
                (i.onreadystatechange = function () {
                    if (4 === i.readyState && 200 === i.status) {
                        ...
                        if (t) {
                            ...
                            for (
                                var a,
                                    o = t.querySelectorAll("TrackingEvents event"),
                                    r = 0,
                                    n = o.length;
                                r < n;
                                r++
                            )
                                (a = o[r]), this.addEvent(a.getAttribute("name"), e(a));
                            if (((this.loaded = !0), this.queue))
                                for (; this.queue.length; ) this.trackEvent(this.queue.shift());
                        }
                    }
                }.bind(this)),
                i.send();
        ...
        trackEvent: function (t) {
            if (this.inited) {
                if (!this.loaded)
                    return (this.queue = this.queue || []), void this.queue.push(t);
                var e = this.events[t];
                if (e && e.length)
                    for (var i = 0, a = e.length; i < a; i++) this.sendToURL(e[i]);
            }
        },
    ...
    eventProcessingObject = {
        subscribers: {},
        subscribe: function (inFunction, event, listenerScope) {
            "string" == typeof event && (event = [event]);
            for (var a = 0, o = event.length; a < o; a++) {
                var r = event[a];
                this.subscribers[r] || (this.subscribers[r] = []),
                    this.subscribers[r].push({
                        fn: inFunction,
                        ctx: listenerScope || null,
                    });
            }
        },
        unsubscribe: function (inFunction, event) {
            "string" == typeof event && (event = [event]);
            for (var i = event.length; i >= 0; i--) {
                var a = this.subscribers[event[i]];
        ...
        callEvent: function (creativeEvent) {
            creativeEvent.type != eventDescriptionObject.AdRemainingTimeChange &&
            creativeEvent.type != eventDescriptionObject.AdError &&
            injectContentObject.log(
                "DispatchEvent =>",
                creativeEvent.type,
                A.getViewAbility(
                    mainAdObject.viewAbilityPercent,
                    mainAdObject.viewAbilityHasFocus
                ).state,
                (this.subscribers[creativeEvent.type] || []).length
            );
            (this.subscribers[creativeEvent.type] || []).forEach(function (e) {
                //we call external function which call extarnal lib and call link
                //from TrackingEvents in XML
                //TRACKING HERE
                //console.log("callEvent(creativeEvent)", creativeEvent);
                if (
                    creativeEvent.type == eventDescriptionObject.AdUserClose ||
                ...
                if (e.fn) {
                    if (creativeEvent.type == eventDescriptionObject.AdClickThru) {
                        console.log("AdClickThru", creativeEvent);
                    }
                    if (
                        creativeEvent.type == eventDescriptionObject.AdClickThru &&
                        (mainAdObject.customParams.plc || creativeEvent.data.playerHandles)
                    ) {
                        e.fn.call(
                            e.ctx,
                            creativeEvent.data.url,
                            creativeEvent.data.id,
                            creativeEvent.data.playerHandles
                        );
                    } else {
    ...
    mainAdObject = Object.create(Object.prototype, {
        linear: {
            ...
            set: function (t) {
                ...
                ((this._linear = t),
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdLinearChange,
                            {
                                value: t,
                            }
                        )
        ...
        isPreviewer: {
            get: function () {
                return (
                    ...
                    r.getPosition() !== r.X_FRAME &&
                    (this._isPreviewer =
                        "clients.weborama.nl" == currentWindow.top.location.host
                            ? "preview"
                            : "none")),
        ...
        remainingTime: {
            ...
            set: function (t) {
                ...
                ((this._remainingTime = t),
                    ...
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdRemainingTimeChange,
                            {
        ...
        canSkip: {
            ...
            set: function (t) {
                ...
                ((this._canSkip = t),
                    ...
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdSkippableStateChange,
                            {
                                value: t,
                            }
                        )
        ...
        adSize: {
            ...
            set: function (t) {
                if (
                    (this._adSize
                        ? (this._adSize.width === t.width &&
                        this._adSize.height === t.height) ||
                        ((this._adSize = t),
                            videoDomElementsAndPostMessages.update({
                            ...
                            eventProcessingObject.callEvent(
                                eventDescriptionObject.create(
                                    eventDescriptionObject.AdSizeChange,
                                    {
                                        width: t.width,
                                        height: t.height,
                                    }
                    ...
                    if (this.fullscreen)
                        return void (this.playerSize = "PlayerFullscreen");
        ...
        duration: {
            ...
            set: function (t) {
                ...
                ((this._duration = t),
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdDurationChange,
                            {
                                duration: t,
                            }
                        )
        ...
        volume: {
            ...
            set: function (t) {
                if (this._volume !== t) {
                    ...
                    try {
                        "undefined" != typeof mainVideo.video &&
                        (mainVideo.video.volume = t);
                    } catch (e) {
                        injectContentObject.error("set volume", t, e);
                    }
                    cntEventsTracking.trackEvent(eventDescriptionObject.AdVolumeChange),
                        eventProcessingObject.callEvent(
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdVolumeChange,
                                {
                                    volume: t,
                                }
                            )
        ...
        mute: {
            ...
            set: function (t) {
                if ("undefined" != typeof mainVideo.video) {
                    try {
                    ...
                    mainVideo.video.f ||
                    (t
                        ? mainVideo.video.setAttribute("muted", "muted")
                        : mainVideo.video.removeAttribute("muted"));
                }
                this._mute = !!t;
            },
        },
        state: {
            set: function (t) {
                this.state !== t &&
                this.state !== eventDescriptionObject.AdStopped &&
                ((this._state = t),
                    videoDomElementsAndPostMessages.update({
                        type: t,
                        data: this.metaData,
                    }),
                    cntEventsTracking.trackEvent(t),
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(t, this.metaData)
                    ));
            },
            get: function () {
                return this._state;
        ...
        metaData: {
            ...
            set: function (t) {
                if (this._metaData) {
                    (this._metaData = t),
                    t.currentTime >= this.customParams.co &&
                    (mainAdObject.canSkip = !0);
                    var e = t.currentTime / t.totalTime;
                    e >= 0.25 &&
                    mainAdObject.middleEvents[0] === !1 &&
                    ((mainAdObject.middleEvents[0] = !0),
                        cntEventsTracking.trackEvent(
                            eventDescriptionObject.AdVideoFirstQuartile
                        ),
                        eventProcessingObject.callEvent(
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdVideoFirstQuartile,
                    ...
                    e >= 0.5 &&
                    mainAdObject.middleEvents[1] === !1 &&
                    ((mainAdObject.middleEvents[1] = !0),
                        cntEventsTracking.trackEvent(
                            eventDescriptionObject.AdVideoMidpoint
                        ),
                        eventProcessingObject.callEvent(
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdVideoMidpoint,
                    ...
                    e >= 0.75 &&
                    mainAdObject.middleEvents[2] === !1 &&
                    ((mainAdObject.middleEvents[2] = !0),
                        cntEventsTracking.trackEvent(
                            eventDescriptionObject.AdVideoThirdQuartile
                        ),
                        eventProcessingObject.callEvent(
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdVideoThirdQuartile,
                    ...
                    mainAdObject.customParams.fdc &&
                    t.totalTime - t.currentTime < mainAdObject.customParams.fdc &&
                    mainAdObject.middleEvents[3] === !1 &&
                    ((mainAdObject.middleEvents[3] = !0),
                        cntEventsTracking.trackEvent(
                            eventDescriptionObject.AdVideoComplete
                        ),
                        A.stop());
                ...
                mainAdObject.remainingTime =
                    this.metaData.totalTime - this.metaData.currentTime;
            },
        },
        middleEvents: {
            value: [!1, !1, !1, !1],
        ...
        origin: {
            get: function () {
                if (!this._origin) {
                    var t =
                        mainAdObject.adParameters.customView ||
                        mainAdObject.adParameters.mediapath,
                        e = t.split("/");
        ...
        location: {
            get: function () {
                if (!this._location)
                    if (
                        ((this._location = encodeURIComponent(
                            mainAdObject.realWindow.location.href
                        )),
                        r.getPosition() !== r.X_FRAME)
                    )
                        this._location = encodeURIComponent(
                            currentWindow.top.location.href
                        );
                    else
                        try {
                            ...
                            if (e && e.length > 0) {
                                ...
                                i.indexOf("chrome-extension") >= 0
                                    ? (this._location = encodeURIComponent(
                                    "fraudulent-chromium-extension"
                                    ))
                                    : "http://a" == i || "https://a" == i
                                    ? (this._location = encodeURIComponent(e[0]))
                                    : (this._location = encodeURIComponent(i));
                            }
                        } catch (a) {}
        ...
        realWindow: {
            get: function () {
                var t = (
                    videoDomElementsAndPostMessages.overlayRoot ||
                    videoDomElementsAndPostMessages.root
                ).ownerDocument;
        ...
        format: {
            get: function () {
                return this.adParameters && this.adParameters.format
                    ? this.adParameters.format
                    : l.SIMPLE;
            },
        },
        flags: {
    ...
    p = {
        ...
        init: function () {
            if (!this.flags.inited && !this.flags.started)
                return (this.flags.inited = !0), !0;
        },
        play: function () {
            return (
                !(!this.flags.inited || this.flags.started) &&
                ((this.flags.started = !0),
                    (mainAdObject.animationStartTime = Date.now()),
                    void (mainAdObject.animationInterval = setInterval(function () {
                        ...
                        return i.currentTime >= i.totalTime
                            ? (p.stop(), void p.complete())
                            : (p.flags.videoStart ||
                            ((p.flags.videoStart = !0),
                                n.call(
                                    p,
                                    eventDescriptionObject.create(
                                        eventDescriptionObject.AdVideoStart,
                                        i
                                    )
                                )),
                                void (
        ...
        stop: function () {
            return (
                ...
                ((this.flags.stopped = !0),
                    void clearInterval(mainAdObject.animationInterval))
            );
        },
        complete: function () {
            (mainAdObject.state = eventDescriptionObject.AdVideoComplete),
        ...
        event: function (eventType) {
            if (!this.flags.stopped) {
                ...
                switch (eventType) {
                    case "play":
                        this.flags.videoStart &&
                        n.call(
                            this,
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdPlaying,
                                e
                            )
                        );
                        break;
                    case "pause":
                        ...
                        n.call(
                            this,
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdPaused,
                                e
                            )
                        );
                        break;
                    ...
                    case "error":
                        injectContentObject.error(
                            "JS-VPAID-VIEWST::ERROR => mediaElement as animation"
                        ),
                            n.call(
                                this,
                                eventDescriptionObject.create(eventDescriptionObject.AdError, e)
                            );
                        break;
                    case "timeupdate":
                    ...
                    default:
                        injectContentObject.error(
                            "JS-VPAID-VIEWST::ERROR => wrong animation timer event"
                        );
                }
            }
        },
    ...
    mainVideo = {
        ...
        init: function (videoElement) {
            if (!this.flags.inited && !this.flags.started) {
                        ...
                        function (t) {
                            if (!this.flags.stopped) {
                                ...
                                switch (t.type) {
                                    ...
                                    case "error":
                                        injectContentObject.error(
                                            "JS-VPAID-VIEWST::ERROR => mediaElement",
                                            t
                                        ),
                                            n.call(
                                                this,
                                                eventDescriptionObject.create(
                                                    eventDescriptionObject.AdError,
                                                    e
                                                )
                                            );
                                        break;
                ...
                for (
                    ...
                    "undefined" != typeof this.video.hasAttribute &&
                    this.video.hasAttribute("src") &&
                    "" != this.video.getAttribute("src") &&
                    ((mainAdObject.savedSource = this.video.getAttribute("src")),
                    ...
                    if (this.video.canPlayType(mediaFiles[i].type)) {
                        ...
                        if (
                            ((currentVideoSource.type = mediaFiles[i].type),
                                (currentVideoSource.src = mediaFiles[i].src),
                                (currentVideoSource.id =
                                    "wb-src-" + Math.round(1e12 * Math.random()).toString(36)),
                            "function" == typeof this.video.appendChild &&
                            this.video.appendChild(currentVideoSource),
                            (this.video.f && this.video.f.indexOf("goog_") != -1) ||
                        ...
                        "undefined" != typeof this.video.load && this.video.load(),
                            (a = !0);
                    }
                }
                ...
                if (c.indexOf("Chrome") < 0 && c.indexOf("Safari") >= 0) {
                    ...
                    (l = c.indexOf("Safari")),
                        (m = c.substring(l + 7)),
                    (l = c.indexOf("Version")) != -1 && (m = c.substring(l + 8));
                    var p = parseInt(m.substring(0, 2));
                    p >= 11 && ((mainAdObject.volume = 0), (mainAdObject.mute = !0));
                }
                return (
                    r.getPosition() == r.X_FRAME &&
                    mainAdObject.customParams.sd > 0 &&
                    ((mainAdObject.volume = 0), (mainAdObject.mute = !0)),
                        a
                );
            }
        },
        ...
        pause: function () {
            !this.flags.paused &&
            this.flags.started &&
            ((this.flags.paused = !0), this.video.pause());
        },
        rewind: function (t) {
        ...
        stop: function () {
            return (
                !(!this.flags.started || this.flags.stopped) &&
                ((this.flags.stopped = !0), void this.pause())
            );
        },
        events: ["play", "pause", "ended", "timeupdate", "error"],
    };
    ...
    videoDomElementsAndPostMessages = {
        ...
        init: function (vpaidSlot, vpaidVideoPlayer) {
            ...
            S.active &&
            ((this.overlayRoot = S.slot.appendChild(
                currentDocument.createElement("div")
            )),
                (this.overlayRoot.id = this.root.id + "-overlay"),
                (this.overlayRoot.className = "wb-overlay"),
                this.overlayRoot.appendChild(a.cloneNode()));
            if (mainAdObject.customParams.ivs || !vpaidVideoPlayer) {
                this.videoElement = this.root.appendChild(
                    currentDocument.createElement("video")
                );
                ...
                mainAdObject.customParams.up &&
                (this.videoElement.poster =
                    mainAdObject.adParameters.mediapath + "poster.png");
                ...
                (this.videoElement.poster =
                    mainAdObject.adParameters.mediapath + "poster.png");
                mainAdObject.customParams.vcl &&
                this.videoElement.addEventListener("click", function (t) {
                    videoDomElementsAndPostMessages.update({
                        type: eventDescriptionObject.AdClickThru,
                        data: {
                            value: mainAdObject.customParams.vcl,
            ...
            this.updateSize();
            mainAdObject.realWindow.addEventListener(
                "message",
            ...
            /** set frame params **/
            this.frameElement = (this.overlayRoot || this.root).appendChild(
                currentDocument.createElement("iframe")
            );
            ...
            this.frameElement.src =
                (mainAdObject.adParameters.customView
                    ? mainAdObject.adParameters.customView
                    : mainAdObject.adParameters.mediapath + "index.html") +
                "?id=" +
                this.root.id;
        ...
        hide: function (t) {
            this.frameElement &&
            (this.frameElement.style.display = t ? "none" : "inline-block");
        },
        update: function (updateData) {
            //console.log("postMessage update", updateData);
            if (
                updateData.type === "AdUserClose" ||
                updateData.type === "AdStopped"
            ) {
                //console.log("postMessage update", updateData);
            }
            this.frameElement &&
        ...
        destroy: function () {
            if (
                ...
                "function" != typeof this.root.parentNode.removeChild
            )
                return !1;
            if (
                (this.root.parentNode.removeChild(this.root),
                this.videoElement && this.videoElement.attributes)
            )
                for (; this.videoElement.attributes.length; )
                    this.videoElement.removeAttribute(
                        this.videoElement.attributes[0].nodeName
                    );
            for (var t in mainAdObject.savedAttributes)
                this.videoElement.setAttribute(t, mainAdObject.savedAttributes[t]);
            if (
                (mainAdObject.savedSource &&
                "" !== mainAdObject.savedSource &&
                (this.videoElement.setAttribute("src", mainAdObject.savedSource),
                    this.videoElement.load(),
                    this.videoElement.play()),
                "function" == typeof this.videoElement.querySelectorAll)
            )
                for (
                    var e = this.videoElement.querySelectorAll("source[id^='wb-src-']"),
                        i = 0;
                    i < e.length;
                    i++
                )
            ...
            if (this.videoElement && this.videoElement.attributes)
                for (
                    var a, i = 0, o = this.videoElement.attributes, r = o.length;
                    i < r;
                    i++
                )
                    a = o[i];
            return (
                this.overlayRoot &&
                this.overlayRoot.parentNode &&
                this.overlayRoot.parentNode.removeChild &&
                this.overlayRoot.parentNode.removeChild(this.overlayRoot),
                    !0
            );
        },
        cssStyle: function (newCssStyle) {
            mainAdObject.customParams.fh ||
            ((this.root.style.cssText = newCssStyle), this.updateSize());
        },
        resizeVideoElement: function (t) {
            ...
            (((0 != t.left && 0 !== t.left.indexOf("0")) ||
                (0 != t.top && 0 !== t.top.indexOf("0")) ||
                "100%" !== t.width ||
                "100%" !== t.height) &&
            ((mainAdObject.flags.resizeVideoElement = !0),
                (this.videoElement.style.position = "absolute")),
                (this.videoElement.style.width = e(t.width)),
                (this.videoElement.style.height = e(t.height)),
                (this.videoElement.style.top = e(t.top)),
                (this.videoElement.style.left = e(t.left)));
        },
        translateVideoElement: function (t) {
            if (this.videoElement && this.videoElement.style) {
                var e = t.hor ? "-50%," : "0,",
                    i = t.ver ? "-50%)" : "0)",
                    a = "translate(" + e + i;
                (this.videoElement.style.webkitTransform = a),
                    (this.videoElement.style.transform = a);
            }
        },
        updateSize: function (type) {
            ...
            return (
                !!this.root &&
                (S.active && S.updateSize(),
                    void (
                        mainAdObject2.customParams.fh ||
                        ((this.root.style.width = mainAdObject2.adSize.width + "px"),
                            (this.root.style.height = mainAdObject2.adSize.height + "px"),
                        !mainAdObject2.flags.resizeVideoElement &&
                        this.videoElement &&
                        this.videoElement.style &&
                        ((this.videoElement.style.width =
                            mainAdObject2.adSize.width + "px"),
                            (this.videoElement.style.height =
                                mainAdObject2.adSize.height + "px")))
                    ))
            );
        },
        setETDuration: function (t) {
            videoDomElementsAndPostMessages.etDuration >= 0
                ? (videoDomElementsAndPostMessages.etDuration += t)
                : (videoDomElementsAndPostMessages.etDuration = t);
        },
    };
    ...
    cntEventsTracking = {
        init: function (e, viewableEvents) {
            ...
            this.options.protocol.indexOf("http") == -1 &&
        ...
        rtbEvent: function (t) {
            if (t || 0 === t) {
                var e =
                    "{{protocol}}//rtb.com.ru/event?type=clickExtra&tracking={{impid}}&index={{eventindex}}&noRedirect=true";
                (this.options.impid = mainAdObject.customParams.impid),
                    (this.options.eventindex = t),
    ...
    r.prototype.hasFocus = function () {
        return (
            ("undefined" === currentDocument.hidden ||
                currentDocument.hidden !== !0) &&
            (r.getPosition() === r.X_FRAME ||
                "function" != typeof currentWindow.top.document.hasFocus ||
                currentWindow.top.document.hasFocus())
        );
    };
    r.prototype.getPosition = function () {
        if (!this.position)
            if (currentWindow.top === mainAdObject.realWindow)
                this.position = r.ON_PAGE;
            else {
    ...
    r.prototype.init = function (t, e) {
        if (this.intersectionSupport) {
            ...
            (this.intersectionObserver = new i(
                function (t) {
                    this.intersectionRatio =
                        Math.round(1e4 * t[0].intersectionRatio) / 100;
                }.bind(this),
                {
            ...
            if (t && t.length && "function" == typeof e)
                for (; t.length; ) e(t.shift().name + r.UNDETERMINED);
            return !1;
        }
        2 == arguments.length &&
        t &&
        ...
        "function" == typeof e &&
        ((this.observerData = t),
            (this.observerHandler = e),
            (this.updater = setInterval(r.updateTime.bind(this), r.DELAY)));
    };
    r.prototype.stop = function (t) {
        if (
            (clearInterval(this.updater),
                r.updateTime.call(this),
            this.observerData && this.observerData.length && !t)
        )
            for (; this.observerData.length; )
                this.observerHandler(this.observerData.shift().name + r.NOT_VIEWABLE);
        this.observerData = [];
    };
    r.prototype.getViewAbility = function (e, i) {
        if (this.intersectionSupport)
            return r.match(this.hasFocus(), i, this.intersectionRatio, e);
        if (r.getPosition() == r.X_FRAME)
            return {
        ...
        try {
            for (; o !== currentWindow.top; ) {
                var d =
                    o.name ||
                    (o.name = "wb-" + Math.round(1e6 * Math.random()).toString(16));
                (o = o.parent),
                    (n = o.frames[d].frameElement.getBoundingClientRect()),
                    (s = Math.min(r.calculateArea(n, o), s));
            }
        } catch (u) {
            return {
                state: r.UNDETERMINED,
    ...
    r.updateTime = function () {
        ...
        for (var e = [], i = 0; i < this.observerData.length; i++) {
            ...
            a.duration.indexOf("%") == -1 ||
            isNaN(mainAdObject.metaData.totalTime) ||
            (a.duration =
                (Math.floor(2 * mainAdObject.metaData.totalTime) / 2) *
                parseInt(a.duration, 10) *
                10),
                (!a.useFocus || t.focus) && Math.round(t.percent) >= a.percent
                    ? "true" == a.useSound
                    ? (a.timeInView = mainAdObject.mute
                        ? 0
                        : r.DELAY + (a.timeInView || 0))
                    : (a.timeInView = r.DELAY + (a.timeInView || 0))
                    : (a.timeInView = 0),
                a.timeInView >= a.duration
                    ? this.observerHandler(a.name + r.VIEWABLE)
                    : e.push(a);
        }
        this.observerData = e;
    };
            ...
            if (i && i.length)
                for (var o in i)
                    if (i.hasOwnProperty(o)) {
                        ...
                        (a.src = i[o]),
                            (a.style.cssText =
                                "width:1px;height:1px;visibility:hidden;position:absolute;border:0"),
                            t.appendChild(a);
                    }
        },
        log: function () {
            ...
            console.log.apply(
                console,
                ["JS-VPAID-VIEWST::INFO =>"].concat(arguments)
            );
        },
        warn: function () {
            console.log.apply(
                console,
                ["JS-VPAID-VIEWST::WARN =>"].concat(arguments)
            );
        },
        error: function () {
            ...
            console.log.apply(
                console,
                ["JS-VPAID-VIEWST::ERROR =>"].concat(arguments)
            );
        },
    };
    ...
    possibleMainAdUnit.prototype.initAd = function (
        width,
        height,
        viewMode,
        n,
        ...
        console.log("initAd");
        if (
            ("string" == typeof adParameters &&
            ((adParameters = {
                AdParameters: adParameters,
            }),
                injectContentObject.warn(
                    'The typeof parameter "creativeData" should be an "object" with key "AdParameters"'
                ),
                injectContentObject.warn(
                    "Read page 44 from https://www.iab.com/wp-content/uploads/2015/06/VPAID_2_0_Final_04-10-2012.pdf"
                )),
            "object" != typeof adParameters ||
            !adParameters.AdParameters ||
            "object" != typeof slotInDomIds ||
            !slotInDomIds.slot)
        ) {
            return (
                injectContentObject.error(errorMessagesAndCodes.WRONG_INIT_PARAMS),
                    injectContentObject.error("initAd", arguments),
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdError,
                            errorMessagesAndCodes.WRONG_INIT_PARAMS
                        )
                    )
            );
        }
        ...
        try {
            ...
            return (
                injectContentObject.error(errorMessagesAndCodes.WRONG_AD_PARAMETERS),
                    injectContentObject.error("initAd", arguments),
                    eventProcessingObject.callEvent(
                        eventDescriptionObject.create(
                            eventDescriptionObject.AdError,
                            errorMessagesAndCodes.WRONG_AD_PARAMETERS
                        )
                    )
            );
        }
        ...
        if (
            ((slotInDomIds.slot && 1 === slotInDomIds.slot.nodeType) ||
            ((slotInDomIds.slot = currentDocument.body),
                injectContentObject.warn('Invalid parameter "environmentVars.slot"')),
            mainAdObject.format === l.WOW)
        ) {
            if (!S.supported())
                return (
                    injectContentObject.error(
                        errorMessagesAndCodes.WOW_ROLL_CROSSDOMAIN_ERROR
                    ),
                        eventProcessingObject.callEvent(
                            eventDescriptionObject.create(
                                eventDescriptionObject.AdError,
        ...
        try {
            if (mainAdObject.adParameters.cp) {
                for (
                    var f = decodeURIComponent(mainAdObject.adParameters.cp).split("|"),
                        E = 0;
                    E < f.length;
                    E++
                ) {
                    if (f[E]) {
                        var P = f[E].split(":");
                        2 == P.length && "" != P[1]
                            ? "undefined" != typeof defaultCustomParams[P[0]]
                            ? (defaultCustomParams[P[0]] = P[1].match(/[a-zA-Z]/i)
                                ? P[1]
                                : parseInt(P[1], 10))
                            : (defaultCustomParams[P[0]] = P[1])
                            : (defaultCustomParams[P[0]] = !0);
                    }
                }
            }
        } catch (m) {}
        if (
            ((mainAdObject.customParams = defaultCustomParams),
                (mainAdObject.playerSizeParams = mainAdObject.adParameters.playerSize || {
                    PlayerSmall: [0, 480],
                ...
                (i = !!mainAdObject.customParams.dm),
                (mainAdObject.defaultVolume = 0.5),
                injectContentObject.log("initAd", arguments),
            slotInDomIds.videoSlot &&
            "undefined" != typeof slotInDomIds.videoSlot.attributes)
        )
            for (
                var R, E = 0, w = slotInDomIds.videoSlot.attributes, D = w.length;
                E < D;
                E++
            )
                (R = w[E]), (mainAdObject.savedAttributes[R.nodeName] = R.nodeValue);
        cntEventsTracking.init(mainAdObject.adParameters.warm, [
            eventDescriptionObject.AdStarted,
            eventDescriptionObject.AdImpression,
            eventDescriptionObject.AdVideoStart,
            eventDescriptionObject.AdVideoFirstQuartile,
            eventDescriptionObject.AdVideoMidpoint,
            eventDescriptionObject.AdVideoThirdQuartile,
        ...
        mainAdObject.customParams.us > 0 &&
        T.init(mainAdObject.adParameters.mediapath + "settings.xml"),
        !slotInDomIds.videoSlot ||
        (1 === slotInDomIds.videoSlot.nodeType &&
            "VIDEO" === slotInDomIds.videoSlot.nodeName.toUpperCase()) ||
        (slotInDomIds.videoSlot.f &&
            slotInDomIds.videoSlot.f.indexOf("goog_") != -1) ||
        ((slotInDomIds.videoSlot = null),
            injectContentObject.warn(
                'Invalid parameter "environmentVars.videoSlot"'
            ));
        ...
        A.init(
            mainAdObject.adParameters.mrcTracker,
            function (t) {
                mainAdObject.flags[t] = !0;
            }.bind(this)
        );
        injectContentObject.injectScripts(
            videoDomElementsAndPostMessages.root,
            mainAdObject.adParameters.scripts
        );
        injectContentObject.injectIFrames(
            videoDomElementsAndPostMessages.root,
            mainAdObject.adParameters.frames
        );
    };
    ...
    possibleMainAdUnit.prototype.stopAd = function () {
        ...
        if (mainAdObject.customParams.nov) {
            ...
            A.stop();
            S.stop();
            videoDomElementsAndPostMessages.destroy() &&
            (mainAdObject.state = eventDescriptionObject.AdStopped);
        } else {
            mainVideo.stop();
            A.stop();
            S.stop();
    ...
    possibleMainAdUnit.prototype.skipAd = function () {
        ...
        if (mainAdObject.customParams.nov) {
            ...
            (injectContentObject.log("skipAd"),
                (mainAdObject.state = eventDescriptionObject.AdSkipped),
                p.stop(),
                A.stop(),
                S.stop(),
                setTimeout(function () {
    ...
    possibleMainAdUnit.prototype.fakePauseAd = function (t) {
        (mainAdObject.flags.userEngaged = !0),
            mainAdObject.customParams.nov ? p.pause() : mainVideo.pause(),
            (mainAdObject.remainingTime = -2),
            (mainAdObject.duration = -2);
    };
    ...
    possibleMainAdUnit.prototype.resumeAd = function () {
        mainAdObject.flags.userEngaged ||
        (mainAdObject.customParams.nov ? p.resume() : mainVideo.resume());
    };
    possibleMainAdUnit.prototype.expandAd = function () {
        eventProcessingObject.callEvent(
            eventDescriptionObject.create(
                eventDescriptionObject.AdLog,
                errorMessagesAndCodes.NOT_ALLOWED_METHOD
            )
        );
    };
    ...
    possibleMainAdUnit.prototype.setAdVolume = function (t) {
        injectContentObject.log("setAdVolume", t),
            (t = "string" == typeof t ? parseInt(t, 10) : t),
        t > 1 && (t /= 100),
        t < 0 && (t = 0),
            (mainAdObject.mute = !t),
            (mainAdObject.volume = t);
    };
    ...
    possibleMainAdUnit.prototype.getAdDuration = function () {
        return mainAdObject.flags.userEngaged
            ? mainAdObject.duration
            : mainAdObject.metaData
                ? mainAdObject.metaData.totalTime
                : -2;
    };
    ...
    possibleMainAdUnit.prototype.subscribe = function (
        inFunction,
        event,
        listenerScope
    ) {
        eventProcessingObject.subscribe(inFunction, event, listenerScope);
    };
    possibleMainAdUnit.prototype.unsubscribe = function (inFunction, event) {
        eventProcessingObject.unsubscribe(inFunction, event);
    };
