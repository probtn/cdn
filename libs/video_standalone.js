(function() {
  ...
  function Start(VideoParams) {
    ...
    var quarterLinks = null;
    if ((VideoParams.QuarterTrackingLinks !== undefined) && (VideoParams.QuarterTrackingLinks !== null) &&
    (VideoParams.QuarterTrackingLinks !== ""))
    {
     quarterLinks = VideoParams.QuarterTrackingLinks;
    }
    ...
    video.ontimeupdate = function() {
      ...
      checkVideoPeriods(currentQuartIndex, quarters, function(vpixel, index) {
        try {
          if (quarterLinks !== null)
          {
            addCounterImageString(quarterLinks[index]);
          }
