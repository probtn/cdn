...
console.log("create broadway_video_ended_event");
    ...
    readBox: function readBox(stream) {
      ...
      switch (box.type) {
        ...
        case 'trak':
          ...
          console.log("Track getTotalTimeInSeconds", this.tracks[box.tkhd.trackId].getTotalTimeInSeconds());
...
var MP4Player = (function reader() {
  ...
  function constructor(stream, useWorkers, webgl, render) {
    ...
    this.avc.onPictureDecoded = function () {
      //console.log("frame decoded", self);
