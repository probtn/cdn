...
(function (root, factory) {
    ...
    var Player = function (parOptions) {
        ...
        var onPictureDecoded = function (buffer, width, height, infos) {
            ...
            //console.log("infos_player", infos);
            ...
            //console.log("msPerItem", msPerItem);
            ...
            //console.log("needToBeTime", needToBeTime, startRenderTime - window.StartTimeDuration, window.VideoFramesCounter);
            if (needToBeTime > startRenderTime - window.StartTimeDuration) {
                diff = needToBeTime - (startRenderTime - window.StartTimeDuration);
            }
            
            //console.log("window.TimeDuration", window.TimeDuration, window.TimeDuration2, startRenderTime, window.PrevStartTime);


            //diff = msPerItem;
            
            //console.log("times: ", startRenderTime, window.PrevStartTime, diff, window.VideoFramesCounter, window.PictureBuffer.length, window.VideoTimeScale);
