...
(function (root, factory) {
    ...
    var Player = function (parOptions) {
        ...
        var onPictureDecoded = function (buffer, width, height, infos) {
            ...
            var posters = document.getElementsByClassName('img_poster');
            Array.prototype.forEach.call(posters, function(item)
            {
              if (item !== null)
              {
...
//-------dirty shity code, sorry, please
            ...
            var elem_canv3 = document.getElementById("canv_3");
            var elem_canv4 = document.getElementById("canv_4");
