...
p.nominalBounds = new cjs.Rectangle(0,0,159,289);
...
(lib.index = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_116 = new cjs.Graphics().p("AHoS+IAA+/IMLhFMAAAAgEg");
	var mask_graphics_134 = new cjs.Graphics().p("AIQThIAA+/IMLhFMAAAAgEg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(116).to({graphics:mask_graphics_116,x:126.8,y:121.5}).wait(18).to({graphics:mask_graphics_134,x:130.8,y:125}).wait(1).to({graphics:null,x:0,y:0}).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({scaleX:1,scaleY:1,y:149.5},9,cjs.Ease.get(1)).wait(39).to({scaleX:0.72,scaleY:0.72,x:232.6,y:142.5},11,cjs.Ease.get(1)).wait(82).to({x:210.6,y:149.5,alpha:0},6,cjs.Ease.get(-1)).to({_off:true},1).wait(127));
...
p.nominalBounds = new cjs.Rectangle(300,284.1,17,30.9);
